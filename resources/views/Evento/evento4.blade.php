    ...
    <main class="container">
        <div class="row m-1 main-imgevent">
            <div class="col-md-12 img-fluid">
                <img src="https://scontent.ftgu3-3.fna.fbcdn.net/v/t1.6435-9/30221955_10155702201188772_938777866907156480_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=0bb214&_nc_ohc=xwZNZSTX_UgAX8JvsBD&_nc_ht=scontent.ftgu3-3.fna&oh=00_AfC4kMniWFlBuyDGf-bQwM7Wsl_GsYhGN-EII_KlEtPRlw&oe=64FA8742"
        ...
        <div class="row g-5">
            <div class="col-md-8">
                <h3 class="pb-4 mb-4 fst-italic border-bottom navyc">
                    Graduaciones de la Universidad de San Pedro Sula
                </h3>

                <article class="blog-post">
                    <h4 class="display-5 link-body-emphasis mb-1">Descripción: </h4>
                    <p class="">
                        ¡Celebremos juntos los logros y el triunfo de la dedicación y el esfuerzo! Es un honor y un
                        privilegio extenderte una
                        cálida invitación a la ceremonia de graduación de nuestra querida universidad. Este es un
                        momento para celebrar el camino recorrido,
                        las metas alcanzadas y el futuro lleno de promesas que aguarda a cada uno de nuestros graduados.
                    </p>
                    <hr>
            ...
            <div class="col-md-4 ">
                <div class="position-sticky" style="top: 2rem;">
                    <div class="p-4 mb-3 bg-body-tertiary rounded yellowb">
                        ...
                        <br>
                        <h5>Fecha:</h5>
                        <p class="mb-0">Sábado 02 de diciembre <del></del> 2023.</p>
                        <br>
                        <h5>Invitados especiales:</h5>
                        <p class="mb-0">Por reservación</p>
                    </div>
