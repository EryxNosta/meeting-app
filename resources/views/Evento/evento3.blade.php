    ...
    <main class="container">
        <div class="row m-1 main-imgevent">
            <div class="col-md-12 img-fluid">
                <img src="https://ibizahn.com/wp-content/uploads/2021/03/Dia-de-los-muertos-Jholeyson.png"
        ...
        <div class="row g-5">
            <div class="col-md-8">
                <h3 class="pb-4 mb-4 fst-italic border-bottom navyc">
                    FIESTA DE FIN DE MES - HALLOWEEN
                </h3>

                <article class="blog-post">
                    <h4 class="display-5 link-body-emphasis mb-1">Descripción: </h4>
                    <p class="">
                        ¡Únete a nosotros para una noche de emociones y sustos en nuestra fiesta anual de Halloween!
                        Viste con tu disfraz más original y lista
                        para pasar un rato de muerte. Nuestra casa encantada te dará escalofríos, y nuestra estación de
                        tallado de calabazas te permitirá expresar
                        tu lado creativo. Disfruta de deliciosas golosinas como manzanas de caramelo y pastel de
                        calabaza, y baila toda la noche con nuestro DJ
                        pinchando canciones espeluznantes. No te pierdas nuestro concurso de disfraces, donde podrás
                        ganar premios por los disfraces más scaris,
                        divertidos y creativos. ¡Vamos a tener una buena pesadilla! ¡Todos somos brujos y brujas por un
                        día! ¡Asustanos con tus trajes y disfraces!
                    </p>
                    <hr>
            ...
            <div class="col-md-4 ">
                <div class="position-sticky" style="top: 2rem;">
                    <div class="p-4 mb-3 bg-body-tertiary rounded yellowb">
                        <h4 class="fst-italic">Museo de Antropología de Honduras</h4>
                        <br>
                        <h5>Dirección:</h5>
                        <p class="mb-0">3ra Ave. 3 & 4 Calle. N.O. 21102. San Pedro Sula</p>
                        <br>
                        <h5>Fecha:</h5>
                        <p class="mb-0">Lunes 30 de Octubre <del></del> 2023.</p>
                        <br>
                        <h5>Precio por persona:</h5>
                        <p class="mb-0">Lps. 150.00 </p>
                    </div>
                            ...
                            <li>
                                <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                                    ...
                                    <img class="bd-placeholder-img" width="100%" height="96"
                                        src="https://www.banpais.hn/wp-content/uploads/2019/07/Slider-La-Prensa-2.jpg"
                                        alt="">
                                </a>
                            </li>
                        </ul>
