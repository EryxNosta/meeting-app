...
<body>
    ...
    <div class="container">
        ...
        <div>
            <form id="search-form" class="row g-4 mt-3 pb-3 shadow-lg" action="{{ route('eventos.search') }}"
                method="GET">
                @csrf
                <div class="col-md-6">
    ...
    <div class="container mt-5 bg-y">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            ...
            <ul class="nav col-md-4 justify-content-end">
                <li class="nav-item"><a href="/" class="nav-link px-2 text-body-secondary txt-red">Inicio</a>
                </li>
                <li class="nav-item"><a href="evento" class="nav-link px-2 text-body-secondary txt-red">Eventos</a>
                </li>
                <li class="nav-item"><a href="Creacion_Eventos"
                        class="nav-link px-2 text-body-secondary txt-red">Organizar</a></li>
            </ul>
        </footer>
    </div>
                ...
                fetch(`/api/events?start_date=${startDate}&end_date=${endDate}`)
                    ...
                    .then(data => {
                        ...
                        data.forEach(function(event) {
                            ...
                            eventItem.innerHTML = '<div class="event-name">' + event.even_nom +
                                '</div>' +
                                '<div class="event-description">Description: ' + event
                                .even_desc + '</div>' +
                                '<div class="event-date">Date: ' + event.even_date + '</div>' +
                                '<div class="event-address">Address: ' + event.even_adrs +
                                '</div><br>';
